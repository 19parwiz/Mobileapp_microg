                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      InkWell(
                                        onTap: () {
                                          provider.updateSettings(
                                            provider.settings.copyWith(language: 'en'),
                                          );
                                            ...
                                            children: [
                                              Expanded(
                                                child: Text(
                                                  'English',
                                                  style: TextStyle(
                                                    fontWeight: provider.settings.language == 'en'
                                                        ? FontWeight.w600
                                                        : FontWeight.normal,
                                                    color: provider.settings.language == 'en'
                                                        ? AppColors.primary
                                                        : null,
                                                  ),
                                                ),
                                              ),
                                              if (provider.settings.language == 'en')
                                                const Icon(
                                                  Icons.check,
                                                  color: AppColors.primary,
                                                  size: 20,
                                      ...
                                      InkWell(
                                        onTap: () {
                                          provider.updateSettings(
                                            provider.settings.copyWith(language: 'fa'),
                                          );
                                          Navigator.of(dialogContext).pop();
                                        },
                                        child: Padding(
                                            ...
                                            children: [
                                              Expanded(
                                                child: Text(
                                                  'فارسی (Farsi)',
                                                  style: TextStyle(
                                                    fontWeight: provider.settings.language == 'fa'
                                                        ? FontWeight.w600
                                                        : FontWeight.normal,
                                                    color: provider.settings.language == 'fa'
                                                        ? AppColors.primary
                                                        : null,
                                                  ),
                                                ),
                                              ),
                                              if (provider.settings.language == 'fa')
                                                const Icon(
                                                  Icons.check,
                                                  color: AppColors.primary,
                                                  size: 20,
                                      ...
                                      InkWell(
                                        onTap: () {
                                          provider.updateSettings(
                                            provider.settings.copyWith(language: 'kk'),
                                          );
                                          Navigator.of(dialogContext).pop();
                                        },
                                        child: Padding(
                                            ...
                                            children: [
                                              Expanded(
                                                child: Text(
                                                  'Қазақша (Kazakh)',
                                                  style: TextStyle(
                                                    fontWeight: provider.settings.language == 'kk'
                                                        ? FontWeight.w600
                                                        : FontWeight.normal,
                                                    color: provider.settings.language == 'kk'
                                                        ? AppColors.primary
                                                        : null,
                                                  ),
                                                ),
                                              ),
                                              if (provider.settings.language == 'kk')
                                                const Icon(
                                                  Icons.check,
                                                  color: AppColors.primary,
                                                  size: 20,
                                      ...
                                      InkWell(
                                        onTap: () {
                                          provider.updateSettings(
                                            provider.settings.copyWith(language: 'ru'),
                                          );
                                          Navigator.of(dialogContext).pop();
                                        },
                                        child: Padding(
                                            ...
                                            children: [
                                              Expanded(
                                                child: Text(
                                                  'Русский (Russian)',
                                                  style: TextStyle(
                                                    fontWeight: provider.settings.language == 'ru'
                                                        ? FontWeight.w600
                                                        : FontWeight.normal,
                                                    color: provider.settings.language == 'ru'
                                                        ? AppColors.primary
                                                        : null,
                                                  ),
                                                ),
                                              ),
                                              if (provider.settings.language == 'ru')
                                                const Icon(
                                                  Icons.check,
                                                  color: AppColors.primary,
                                                  size: 20,
